...
class User extends MY_Controller {
    ...
    public function email()
    {
        $config = Array(
        'protocol' => 'smtp',
        'smtp_host' => 'mail.alaziziglobalprojects.com',
        'smtp_port' =>  587,
        'smtp_user' => 'test1@alaziziglobalprojects.com',    //email id
        'smtp_pass' => '~O8xr$6~9Nel',            // password
        'mailtype'  => 'html', 
        'charset'   => 'iso-8859-1'
        );  
        $this->load->library('email', $config);  

            $from_email = 'test1@alaziziglobalprojects.com';
            $this->email->set_newline("\r\n");
            $this->email->from($from_email, 'CRM ALAZIZI'); 
            $this->email->to('ashwani.codesoftic@gmail.com');
